...
class CreateHistoryLpwoStatusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('history_lpwo_status')) {
            Schema::create('history_lpwo_status', function (Blueprint $table) {
                $table->increments('id');
            });
        }

        $columns = Schema::getColumnListing('history_lpwo_status');
