...
class CreateHistoryWoStatusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('history_wo_status')) {
            Schema::create('history_wo_status', function (Blueprint $table) {
                $table->increments('id');
            });
        }

        $columns = Schema::getColumnListing('history_wo_status');
